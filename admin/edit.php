...
<div class="col-md-10">
<h5 class="text-center">Edit Doctor Info</h5>
...
<h5 class="my-3">Contact:<?php echo $row['phone']; ?></h5>
...
<input type="number" name="salary" class="form-control" placeholder="Enter salary here" value="<?php echo $row['salary']; ?>">
